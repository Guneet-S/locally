  ...
  public: {
    Tables: {
      ...
      contact_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "contact_events_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      product_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_categories_gender_id_fkey"
            columns: ["gender_id"]
            isOneToOne: false
      ...
      reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "reviews_shoppee_id_fkey"
            columns: ["shoppee_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      store_views: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "store_views_viewer_id_fkey"
            columns: ["viewer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      store_wishlists: {
        ...
        Relationships: [
          {
            foreignKeyName: "wishlists_shoppee_id_fkey"
            columns: ["shoppee_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      recently_updated_stores: {
        Args: { limit_n?: number }
        Returns: {
          last_product_added_at: string
          store_id: string
        }[]
      }
      st_3dclosestpoint: {
